...
// const credentials = cfenv.getAppEnv().getService('myAzureStorage').credentials;
const credentials = require('./credentials')

var app = express();

// Global request options, set the retryPolicy
var blobClient = azure.createBlobService(credentials.storageAccountName,
  credentials.accessKey, credentials.primaryBlobServiceEndPoint).withFilter(new azure.ExponentialRetryPolicyFilter());
